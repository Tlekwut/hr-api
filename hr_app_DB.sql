...
--
-- Host: 127.0.0.1    Database: hr_loyalty
-- ------------------------------------------------------
...
CREATE TABLE `employees` (
  ...
  `bio_data` text COLLATE utf8mb4_unicode_ci,
...
INSERT INTO `migrations` VALUES (1,'2014_10_12_000000_create_users_table',1),(2,'2025_02_22_120536_create_auth_logs_table',2),(3,'2025_02_22_121025_create_products_table',3),(4,'2025_02_22_121131_create_purchases_table',4),(5,'2014_10_12_100000_create_password_reset_tokens_table',5),(6,'2019_08_19_000000_create_failed_jobs_table',5),(7,'2019_12_14_000001_create_personal_access_tokens_table',5);
...
CREATE TABLE `purchases` (
  ...
  `purchase_type` enum('redeem','purchase') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'redeem',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
